...
(function ($) {    
    ...
    if ($.fn.ajaxForm == undefined) { $.getScript("https://convivere.azurewebsites.net/js/jquery.form.js"); }
    var feature = {};
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<br><br><span><b>Arrasta y Deposita aqui los archivos</b></span>",
            abortStr: "Abort",
            cancelStr: "Cancel",
            deletelStr: "Delete",
            doneStr: "Done",
            multiDragErrorStr: "Multiples archivos arrastradas no son permitidas.",
            extErrorStr: "tipo de archivo no permitido. Tipos de archivos permitidos: ",
            sizeErrorStr: "archivo demasiado grande. Tamaño maximo permitido: ",
